  ...
  return (
    <AnimatePresence>
      {visible && (
        ...
        >
          <div className="bg-white border-t border-slate-200 px-4 py-3 safe-bottom shadow-2xl">
            <div className="flex gap-2">
              <a
                href="https://wa.me/919025439428"
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 flex items-center justify-center gap-1.5 bg-green-600 hover:bg-green-700 text-white font-semibold py-3 rounded-xl transition-colors cursor-pointer text-sm"
              >
